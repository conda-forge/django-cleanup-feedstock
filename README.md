...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-cleanup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7407&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-cleanup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-cleanup` can be installed with:

```
conda install django-cleanup
```

It is possible to list all of the versions of `django-cleanup` available on your platform with:
